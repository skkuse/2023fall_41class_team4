...
export class Migrations1701802650442 implements MigrationInterface {
    name = 'Migrations1701802650442'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE \`execution_result\` (\`id\` int NOT NULL AUTO_INCREMENT, \`status\` varchar(255) NOT NULL, \`runtime\` int NOT NULL, \`mem_usage\` int NOT NULL, \`core_usage\` int NOT NULL, PRIMARY KEY (\`id\`)) ENGINE=InnoDB`);
