 ...
 * @author Min Ho CHO
 */
export class CarbonEmissionConvertedResultResponseDto {
  ...
  constructor(convertedResult: CarbonEmissionConvertedResultDto) {
    this.carbonFootPrint =
      convertedResult.carbonFootPrint.toFixed(2) + 'µgCO2e';
    this.energy = convertedResult.energy.toFixed(2) + 'µWh';
    this.tvWatchingTime = convertedResult.tvWatchingTime.toFixed(2) + 'μs';
    this.passengerCarMileage =
      convertedResult.passengerCarMileage.toFixed(2) + 'µm';
    this.subwayTravelDistance =
      convertedResult.subwayTravelDistance.toFixed(2) + 'mm';
    this.appleProduction = convertedResult.appleProduction.toFixed(2) + 'µg';
  }
}
